...
PRO subscribers get an API key from [worldmonitor.app/pro](https://www.worldmonitor.app/pro). User-issued keys are exactly `wm_` followed by 40 lowercase hex characters.
